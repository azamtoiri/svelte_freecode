	...
	>
		...
		{#each productFeatures as productFeature, index}
			<ProductCard {productFeature} {index}>
				...
				{:else if index === 1}
					Lay the foundations for <span class="font-medium text-indigo-400">routine</span> and consistency
				{:else}
					Workouts specific to your <span class="font-medium text-indigo-400">environment</span>
					and
